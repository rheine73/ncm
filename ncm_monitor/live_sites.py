...
def buscar_alteracoes_ncm_online(
    ...
    if len(ncm_norm) != 8:
        return LiveScanResult(eventos=[], dias_varridos=0, atos_analisados=0)
    ...
    return LiveScanResult(eventos=eventos[:target_events], dias_varridos=dias_varridos, atos_analisados=atos_analisados)
